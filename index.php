...
<body>
  ...
  <div class="main-container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="/index.html">Fishing Club</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="nav-link" href="/index.html">Strona Głowna <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img class="d-block w-100" src="/Images/RouletePhoto3Crop.jpg" alt="Third slide">
        </div>
        <div class="carousel-item">
    ...
    <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; " class="Container BlogContainer">
      <div class="BlogContainer">
        <p>Tutaj Zobacz posty na naszym blogu!</p>        
      </div>
      <br>
      <div>
      <a href="#Blogs" class="btn btn-dark"> Zobacz Blog! </a>
