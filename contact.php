...
<body style="background-color: #FFFBFB;">
    ...
    <div class="container round-lg self-align-center">
        <div class="d-flex container round-lg bg-light mt-5 align-items-center justify-content-center">
            <h1>
                <p class=" font-weight-light align-items-center bold">
                    KONTAKT
                </p>
            </h1>
        </div>
        <div class="d-flex container round-lg bg-light mt-3 align-items-center justify-content-center">
            <h3>
                <p class=" font-weight-light align-items-center bold">
                    Klub Karaś
                </p>
